 ...
 * @version 1.0
 *
 * Class Description:  Defines the event at which a competition takes place.
 */
public class Event implements Serializable
{
	...
	// Constructors
	/**
	 * Default constructor that sets all instance level variables to their
	 * default values.
	 */
	public Event()
	{
	...
	/**
    * User defined constructor that allows the 
    * programmer to initialize instance variables
    * at the time of declaration of the object
    * instance.
