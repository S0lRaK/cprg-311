...
/**
 * counterADT.CounterADT.java
 *
 * @author kitty
 * @version 1.0
 *
 * Class Definition: This interface represents the public contract for the
 * implementation of counterADT.Counter for the counterADT.CounterADT Exercise.
 */
public interface CounterADT {
    /**
     * Mutator method to modify the value of the counter.
     *
     * Precondition: A valid counterADT.Counter object exists and an integer value
     * is passed.
     *
     ...
     * @throws InvalidCounterException is thrown if a negative value
     *                                 is passed.
     */
     ...
     *
     * Precondition: A valid counterADT.Counter object exists.
     *
